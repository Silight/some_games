#sonar - A treasure hunting game. I was thinking of adding none ASCII graphics and turning this into a sub hunter app for Android. 
...
def drawBoard(board):
    ...
    hline = '    ' #initial space for the left side of the board
    for i in range(1, 6):
        hline += (' ' * 9) + str(i)
...
def makeMove(board, chests, x, y):
    ...
    smallestDistance = 100 #any chest will be closer that 100.
    for cx, cy in chests:
...
def enterPlayerMove():
    #Let the player type in her move. Return a two-line list of int xy coordinates.
...
def playAgain():
    ...
    print('Do you want to play again? (yes or no)30')
...
def showInstructions():
    ...
    represent distances of 2 away from the device. 
...
while True:
    ...
    while sonarDevices > 0:
        ...
        x, y = enterPlayerMove()
        previousMoves.append([x, y]) #we must track all moves so the sonar devices can be updated
